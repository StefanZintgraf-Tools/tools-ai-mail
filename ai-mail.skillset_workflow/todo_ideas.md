...
- check how to apply or benefit from ideas of the riptide stuff (C:\PROJ\github\humanlayer\claude-plugins)


- [ ] check how coding/openspec_pocock_riptide_combination.md can bring new ideas

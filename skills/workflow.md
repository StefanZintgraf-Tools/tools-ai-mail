# Workflow — sequence for ai-mail (with guardrail skills)

The end-to-end order in which to run the steps and the guardrail skills. Skill *behaviour* lives
...
**Legend** — **authoring** = a step that produces a chain artifact · **lens** = cross-cutting

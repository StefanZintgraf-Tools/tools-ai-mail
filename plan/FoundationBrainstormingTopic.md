...
> starts a brainstorming session, load this file as the
> session's starting context — topic and goal are already chosen.
...
thinking about this product. Ignore any sibling brief or other input artifacts.
The whole point of this session is to ask the open question:
...
- **Forget every earlier decision.** Nothing from any prior session or any artifact is a precondition here.

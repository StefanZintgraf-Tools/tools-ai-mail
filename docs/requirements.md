...
| NFR-003 | Proposal Completeness | 100% of proposals must display all five fields — sender, document type, Target Location, and the two confidence scores (type and location) — before the approval step.                                                                                                                                                         | Usability       | High     | Open   |
